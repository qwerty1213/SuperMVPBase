...
//        img_line.setVisibility(View.GONE);
    ...
    public AlertDialogUtil setMsg(String msg) {
        showMsg = true;
        if ("".equals(msg)) {
            txt_msg.setText("内容");
        } else {
    ...
    public AlertDialogUtil setCancelable(boolean cancel) {
    ...
    public AlertDialogUtil setPositiveButton(String text,
    ...
    public AlertDialogUtil setNegativeButton(String text,
                                             final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("取消");
