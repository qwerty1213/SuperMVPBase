 ...
 * 賺取余额页面
 */
public class ShareYEDialogFragment extends BlurDialogFragment {
    ...
    public static ShareYEDialogFragment newInstance(Activity mActivity, ShareBean shareBean) {
        ShareYEDialogFragment.mActivity = mActivity;
        ShareYEDialogFragment.shareBean = shareBean;
        web = new UMWeb(shareBean.url);
        web.setTitle(shareBean.title);
        web.setThumb(shareBean.image);
        web.setDescription(shareBean.content);
        return new ShareYEDialogFragment();
    }
