package com.android.tool.util.statusbar;
...
public class XStatusBar {
    ...
    public void apply() {
        if (type == TYPE_COLOR) {
            setColorBar(colorBuilder.statusColor, colorBuilder.useDart, colorBuilder.statusDepth,
    ...
    public void setColorBar(@ColorInt int statusColor, boolean useDart, int statusDepth,
                            @ColorInt int navColor, int navDepth) {
        setColorBar(statusColor, useDart, statusDepth, true, navColor, navDepth);
    }


    @TargetApi(Build.VERSION_CODES.KITKAT)
    public void setColorBar(@ColorInt int statusColor, boolean useDart, @ColorInt int navColor) {
        setColorBar(statusColor, useDart, 0, navColor, 0);
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.KITKAT)
    private void setColorBar(@ColorInt int statusColor, boolean useDart, int statusDepth, boolean applyNav,
                             @ColorInt int navColor, int navDepth) {
        StatusUtil.setStatusTextColor(useDart, activity);//设置字体颜色
    ...
    public static class ColorBuilder {
        ...
        public ColorBuilder statusBarTextColor(boolean useDart) {
            this.useDart = useDart;
            return this;
        }
