 ...
 */
public class CompleteFragment extends BaseFragments implements OrderAdapter.OnItemClickListener, SuperSwipeRefreshLayout.OnRefreshListener, LoadingView.OnRetryListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void doBusiness() {
        OkGo.<ObjectResponse<OrderBean>>get(PathUtil.getMyBookOrderList())
                ...
                .params(AppConfig.OrderList.STATUS, OrderBean.COMPLETE)//complete 已完成
