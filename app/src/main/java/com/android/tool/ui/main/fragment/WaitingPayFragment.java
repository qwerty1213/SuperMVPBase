 ...
 */
public class WaitingPayFragment extends BaseFragments implements OrderAdapter.OnItemClickListener, SuperSwipeRefreshLayout.OnRefreshListener, LoadingView.OnRetryListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void doBusiness() {
        OkGo.<ObjectResponse<OrderBean>>get(PathUtil.getMyBookOrderList())
                ...
                .params(AppConfig.OrderList.STATUS, OrderBean.INIT)//init 待支付
